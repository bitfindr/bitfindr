  ...
  selectContact() {
    this.contacts
      ...
      .then((contact: Contact) => {
        ...
        this.contact.photo = photos
          ? photos[0].value
          : 'assets/icon/favicon.ico';
      })
      .catch(err =>
        this.toastCtrl.create('There was an error picking your contact: ' + err)
      );
  }

  copyToClipboard(hash) {
    this.clipboard
      .copy(hash, this.renderer)
      .then(() =>
        this.toastCtrl.create(
          'The wallet hash was copied to your clipboard.',
          'center'
        )
      )
      .catch(err =>
        this.toastCtrl.create('There was an error copying your hash: ' + err)
      );
  }
